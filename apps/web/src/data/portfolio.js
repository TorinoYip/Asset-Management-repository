...
const stationRecords = [
  { id: "beichen-wind", name: "北辰风电场", type: "wind", province: "hebei", ownership: "owned", longitude: 114.70, latitude: 41.15, size: "160 MW", capacity: 160, turbines: 25, revenue: .86, cost: .50, margin: .36, attainment: 105.4, ops: "可利用率 98.1%", status: "good" },
  { id: "fengning-wind", name: "丰宁风电场", type: "wind", province: "hebei", ownership: "managed", longitude: 116.65, latitude: 41.20, size: "140 MW", capacity: 140, turbines: 22, revenue: .77, cost: .46, margin: .31, attainment: 101.6, ops: "可利用率 97.8%", status: "good" },
  { id: "baiyunxia-wind", name: "白云峡风电场", type: "wind", province: "hebei", ownership: "owned", longitude: 117.50, latitude: 40.90, size: "100 MW", capacity: 100, turbines: 17, revenue: .55, cost: .34, margin: .21, attainment: 98.8, ops: "可利用率 97.3%", status: "good" },
  { id: "fengning-storage", name: "丰宁储能电站", type: "storage", province: "hebei", ownership: "owned", longitude: 116.75, latitude: 41.10, size: "100 MW / 200 MWh", power: 100, energy: 200, revenue: .75, cost: .43, margin: .32, attainment: 109.7, ops: "综合效率 88.6%", status: "good" },
  ...
  { id: "damao-wind", name: "达茂风电场", type: "wind", province: "inner-mongolia", ownership: "managed", longitude: 110.44, latitude: 41.70, size: "160 MW", capacity: 160, turbines: 25, revenue: .83, cost: .53, margin: .30, attainment: 99.1, ops: "可利用率 96.9%", status: "good" },
  { id: "ordos-storage", name: "鄂尔多斯储能电站", type: "storage", province: "inner-mongolia", ownership: "owned", longitude: 109.78, latitude: 39.61, size: "80 MW / 160 MWh", power: 80, energy: 160, revenue: .61, cost: .36, margin: .25, attainment: 103.6, ops: "综合效率 87.9%", status: "good" },
  { id: "mengxi-storage", name: "蒙西调频储能电站", type: "storage", province: "inner-mongolia", ownership: "managed", longitude: 106.82, latitude: 39.66, size: "60 MW / 120 MWh", power: 60, energy: 120, revenue: .46, cost: .29, margin: .17, attainment: 97.2, ops: "综合效率 86.7%", status: "watch" },

  { id: "haiyue-wind", name: "海岳风电场", type: "wind", province: "shandong", ownership: "owned", longitude: 121.10, latitude: 37.40, size: "150 MW", capacity: 150, turbines: 24, revenue: .75, cost: .50, margin: .25, attainment: 84.0, ops: "可利用率 94.8%", status: "bad" },
  { id: "lingang-wind", name: "临港风电场", type: "wind", province: "shandong", ownership: "managed", longitude: 119.50, latitude: 35.40, size: "120 MW", capacity: 120, turbines: 19, revenue: .64, cost: .40, margin: .24, attainment: 96.5, ops: "可利用率 96.2%", status: "watch" },
  { id: "lingang-storage", name: "临港储能电站", type: "storage", province: "shandong", ownership: "owned", longitude: 119.60, latitude: 35.50, size: "80 MW / 160 MWh", power: 80, energy: 160, revenue: .58, cost: .34, margin: .24, attainment: 104.0, ops: "综合效率 88.2%", status: "good" },

  { id: "zhoushan-wind", name: "舟山风电场", type: "wind", province: "zhejiang", ownership: "owned", longitude: 122.10, latitude: 30.00, size: "130 MW", capacity: 130, turbines: 20, revenue: .68, cost: .42, margin: .26, attainment: 102.1, ops: "可利用率 97.5%", status: "good" },
  { id: "haining-wind", name: "海宁风电场", type: "wind", province: "zhejiang", ownership: "managed", longitude: 120.68, latitude: 30.53, size: "120 MW", capacity: 120, turbines: 18, revenue: .63, cost: .38, margin: .25, attainment: 100.4, ops: "可利用率 97.1%", status: "good" },
  { id: "shaoxing-storage", name: "绍兴储能电站", type: "storage", province: "zhejiang", ownership: "managed", longitude: 120.58, latitude: 30.00, size: "100 MW / 200 MWh", power: 100, energy: 200, revenue: .71, cost: .43, margin: .28, attainment: 101.8, ops: "综合效率 87.6%", status: "good" }
];
